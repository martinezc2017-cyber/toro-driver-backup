...
Email: legal@toro-ride.com
Driver Support: drivers@toro-ride.com
...
To exercise these rights, contact privacy@toro-ride.com
...
''';
  ...
  static const String safetyPolicy = '''
================================================================================
TORO DRIVER - SAFETY POLICY AGREEMENT
Version 1.0 | Effective Date: January 2025
================================================================================

This Safety Policy Agreement ("Policy") outlines the safety standards and
requirements that all Drivers must follow while using the Toro Driver platform.

--------------------------------------------------------------------------------
1. ZERO TOLERANCE POLICY
--------------------------------------------------------------------------------

Toro Driver maintains a ZERO TOLERANCE policy for the following:

A. SUBSTANCE IMPAIRMENT:
- No driving under the influence of alcohol
- No driving under the influence of drugs (legal or illegal)
...
- No sexual harassment or inappropriate conduct
- No verbal abuse or intimidation
- No discrimination of any kind

C. DANGEROUS DRIVING:
- No excessive speeding (15+ mph over limit)
- No reckless driving or street racing
- No use of mobile devices while driving (except GPS)
- No driving while fatigued beyond safe limits
...
Before each shift, you must ensure:

A. VEHICLE CONDITION:
- All lights functioning (headlights, brake lights, turn signals)
- Tires properly inflated with adequate tread
- Brakes functioning properly
- Mirrors properly adjusted
- Windshield clean and unobstructed
- Seatbelts functioning for all passengers

B. CLEANLINESS:
- Interior clean and free of debris
- No offensive odors
- Air conditioning/heating functional
- No hazardous materials in vehicle
...
While providing services, you must:
...
- Wait for passengers to be fully seated before moving
...
- Any accident or collision (no matter how minor)
- Near-miss incidents
- Threatening behavior from riders
- Suspected criminal activity
- Vehicle breakdowns during active trips
- Any safety concerns

Report via: App emergency button, email safety@toro-ride.com, or call support.
...
1. Pull over safely
2. Call 911
3. Provide basic assistance if trained
4. Stay with the passenger until help arrives

--------------------------------------------------------------------------------
6. COVID-19 AND HEALTH SAFETY
--------------------------------------------------------------------------------

During health emergencies, additional requirements may include:
...
You agree to:
- Complete all required safety training modules
- Maintain any required certifications
- Stay updated on safety policy changes
...
MINOR VIOLATIONS:
- Warning and required safety refresher training
- Temporary suspension pending review

MAJOR VIOLATIONS:
- Immediate suspension
- Investigation and review
- Possible permanent deactivation

ZERO TOLERANCE VIOLATIONS:
- Immediate and permanent deactivation
- Report to appropriate authorities if applicable

--------------------------------------------------------------------------------
9. ACKNOWLEDGMENT
--------------------------------------------------------------------------------

By signing this Safety Policy Agreement, I acknowledge that:
...
- I will report all safety incidents promptly
- I prioritize the safety of myself, passengers, and the public
- Violation may result in deactivation and legal consequences

================================================================================
END OF SAFETY POLICY AGREEMENT
================================================================================
''';

  static const String backgroundCheckConsent = '''
================================================================================
TORO DRIVER - BACKGROUND CHECK CONSENT AND AUTHORIZATION
Version 1.0 | Effective Date: January 2025
================================================================================

IMPORTANT: PLEASE READ THIS ENTIRE DOCUMENT CAREFULLY BEFORE SIGNING.

This document authorizes Toro Driver LLC and its designated background check
provider to obtain consumer reports and investigative consumer reports about you.

--------------------------------------------------------------------------------
1. AUTHORIZATION FOR BACKGROUND CHECK
--------------------------------------------------------------------------------

I, the undersigned applicant/driver, hereby authorize Toro Driver LLC ("Company")
and its designated consumer reporting agency to:
...
- Credit bureaus (for identity verification only)

--------------------------------------------------------------------------------
2. DISCLOSURE OF CONSUMER REPORT
--------------------------------------------------------------------------------

In accordance with the Fair Credit Reporting Act (FCRA), you are hereby notified:

A. CONSUMER REPORT DISCLOSURE:
A consumer report and/or investigative consumer report may be obtained for
employment purposes. This report may contain information about your:
- Character
- General reputation
...
The investigation may include personal interviews with sources such as your
neighbors, friends, associates, current and former employers, and others with
knowledge of you.
...
A. REQUEST DISCLOSURE:
Request a complete and accurate disclosure of the nature and scope of the
investigation requested, within 5 business days of your written request.

B. OBTAIN A COPY:
Receive a free copy of any consumer report obtained if you request it.

C. DISPUTE INFORMATION:
Dispute the accuracy or completeness of any information in your consumer report.

D. CONTACT THE CONSUMER REPORTING AGENCY:
The consumer reporting agency that provides the report did not make the decision
to obtain the report and cannot provide specific reasons for any employment action.
...
- May request the nature and substance of all information
- May view the file maintained by the consumer reporting agency
- Are entitled to receive a free copy of their report

NEW YORK RESIDENTS:
- May request a copy of any report upon request
- May inspect the consumer reporting agency's files

Additional state-specific notices are available upon request.
...
A. INITIAL AND ONGOING CHECKS:
This authorization covers background checks:
- At the time of application
- Periodically during my engagement with the platform
- Following any reported incidents
- As required by law or regulation

B. CONTINUOUS MONITORING:
Toro Driver may conduct ongoing monitoring of criminal records and driving
records throughout my engagement with the platform.

--------------------------------------------------------------------------------
6. CERTIFICATION AND ACKNOWLEDGMENT
--------------------------------------------------------------------------------

By signing below, I certify that:

□ I have carefully read and understand this disclosure and authorization

□ I authorize the background check investigation as described

□ All information I have provided is true, accurate, and complete

□ I understand that falsification may result in denial or termination

□ I release all parties from liability for information provided in good faith

□ I understand I may receive a copy of any report upon written request

□ I acknowledge my rights under the FCRA and applicable state laws

--------------------------------------------------------------------------------
7. PERSONAL INFORMATION FOR BACKGROUND CHECK
--------------------------------------------------------------------------------

The following information is required to conduct the background check:
...
Previous Addresses (7 years): ____________________________

--------------------------------------------------------------------------------
8. SIGNATURE AND CONSENT
--------------------------------------------------------------------------------

I HAVE READ THIS DISCLOSURE AND AUTHORIZATION, UNDERSTAND MY RIGHTS, AND
AUTHORIZE TORO DRIVER LLC TO OBTAIN CONSUMER REPORTS ABOUT ME FOR EMPLOYMENT
PURPOSES. I UNDERSTAND THAT THIS AUTHORIZATION WILL REMAIN IN EFFECT THROUGHOUT
MY ENGAGEMENT WITH THE PLATFORM UNLESS I REVOKE IT IN WRITING.
...
================================================================================
END OF BACKGROUND CHECK CONSENT AND AUTHORIZATION
================================================================================
''';
