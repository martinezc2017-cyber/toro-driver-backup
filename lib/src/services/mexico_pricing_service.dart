...
class ZonePricing {
  ...
  factory ZonePricing.fromJson(Map<String, dynamic> json) {
    return ZonePricing(
      ...
      perMin: (json['per_minute'] as num?)?.toDouble() ?? (json['per_min'] as num?)?.toDouble() ?? 0,
      minFare: (json['minimum_fare'] as num?)?.toDouble() ?? (json['min_fare'] as num?)?.toDouble() ?? 0,
      bookingFee: (json['booking_fee'] as num?)?.toDouble() ?? 0,
      nightMultiplier: (json['night_multiplier'] as num).toDouble(),
      weekendMultiplier: (json['weekend_multiplier'] as num).toDouble(),
      maxSurgeMultiplier: (json['surge_multiplier'] as num?)?.toDouble() ?? (json['max_surge_multiplier'] as num?)?.toDouble() ?? 1.0,
      platformFeePercent: (json['platform_percentage'] as num?)?.toDouble() ?? (json['platform_fee_percent'] as num?)?.toDouble() ?? 0,
...
class PricingRule {
  ...
  factory PricingRule.fromJson(Map<String, dynamic> json) {
    return PricingRule(
      ...
      baseFare: (json['base_fare'] as num).toDouble(),
      perKm: (json['per_km'] as num).toDouble(),
      perMin: (json['per_minute'] as num).toDouble(),
      minFare: (json['minimum_fare'] as num).toDouble(),
      bookingFee: (json['booking_fee'] as num?)?.toDouble() ?? 0,
      cancellationFee: (json['cancellation_fee'] as num).toDouble(),
      nightMultiplier: (json['night_multiplier'] as num).toDouble(),
      nightStartHour: json['night_start_hour'] as int? ?? 22,
      nightEndHour: json['night_end_hour'] as int? ?? 6,
      weekendMultiplier: (json['weekend_multiplier'] as num).toDouble(),
      maxSurgeMultiplier: (json['surge_multiplier'] as num?)?.toDouble() ?? 1.0,
      platformFeePercent: (json['platform_percentage'] as num).toDouble(),
      driverPercent: (json['driver_percentage'] as num).toDouble(),
      currency: json['currency'] as String? ?? 'MXN',
